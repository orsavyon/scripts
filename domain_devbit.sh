...
ssh $user@$ip_address -t "echo $password | sudo -S su -c 'echo "blacklist nouveau" > /etc/modprobe.d/blacklist-nouveau.conf;
...
echo 2581999Ors |realm join -v devbit.io -U $domainuser;
